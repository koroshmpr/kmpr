<article class="position-relative card__title-under-image bg-primary px-2 shadow-sm overflow-hidden rounded-2">
    <a class="row rounded-2 d-flex justify-content-center" href="<?php the_permalink(); ?>">
        <img class="post-cover object-fit px-0" src="<?php echo the_post_thumbnail_url(); ?>"
             alt="<?= get_the_title(); ?>">
